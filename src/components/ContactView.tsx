...
export default function ContactView({ user, onLoginRequest }: ContactViewProps) {
  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 xl:px-12">
      <SEO title="Contact Support | PDF Toolkit Pro" description="Get in touch with our support team for help, billing inquiries, or feature requests." canonical="/contact" />
