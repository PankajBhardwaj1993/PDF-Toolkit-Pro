    ...
    <footer className="border-t border-slate-200 dark:border-zinc-900 bg-slate-50 dark:bg-zinc-950/40 pt-16 pb-8 text-sm">
      <div className="mx-auto w-full max-w-[1850px] px-4 sm:px-6 lg:px-8 xl:px-12">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
          {/* Brand Info */}
          <div className="col-span-2 md:col-span-1 lg:col-span-1 xl:col-span-2">
        ...
        <div className="mt-16 pt-8 border-t border-slate-200 dark:border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-400 dark:text-zinc-500">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <span className="w-px h-3 bg-slate-200 dark:bg-white/10 hidden md:block"></span>
            <div className="hidden md:flex items-center gap-2">
              <span className="text-slate-400 dark:text-zinc-500 italic">Recently processed:</span>
              <span className="text-slate-600 dark:text-slate-300 font-mono">Contract_Draft_V2.pdf</span>
              <span className="text-slate-400 dark:text-zinc-600 font-mono">• 2.4 MB • 2 mins ago</span>
            </div>
          </div>
