...
export default function InfoPagesView({ initialSection = 'about', onNavigateToTickets }: InfoPagesViewProps) {
  ...
  return (
    <div className="w-full max-w-[1850px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-12">
      <SEO title="About & Legal | PDF Toolkit Pro" description="About PDF Toolkit Pro, privacy policy, terms of service, and legal disclaimer." canonical="/about" />
                  ...
                  <div className="space-y-3.5 pt-2">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-400">support@pdftoolkitpro.online</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-400">New Delhi, NCR, India</p>
                      </div>
                    </div>
