...
export default function DonationView({ onBackToTools, user, isDonationDisabled = false, onToggleDonation }: DonationViewProps) {
  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 xl:px-12 max-w-5xl 2xl:max-w-6xl mx-auto animate-fade-in space-y-6">
      ...
      <div className="bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-3xl p-6 sm:p-10 shadow-xl max-w-lg mx-auto space-y-8 text-center">
        
        {/* Rendered QR Code Wrapper (Large, Crisp, matching Google Pay screenshot design) */}
        <div className="flex flex-col items-center justify-center py-8 px-6 bg-slate-50 dark:bg-zinc-900/30 rounded-2xl border border-slate-200 dark:border-zinc-800 relative">
          ...
          <div className="w-80 h-80 sm:w-96 sm:h-96 bg-white rounded-3xl shadow-xl overflow-hidden flex items-center justify-center p-6 border-2 border-slate-100 relative">
            {qrDataUrl ? (
              <div className="relative w-full h-full flex items-center justify-center">
                ...
                <div className="absolute w-14 h-14 bg-white rounded-full flex items-center justify-center shadow-lg border border-slate-100 p-2.5">
          ...
          <div className="mt-6 flex flex-col items-center gap-1.5">
            ...
            <span className="text-xs sm:text-sm font-black text-slate-800 dark:text-zinc-100 font-mono tracking-wider bg-white dark:bg-zinc-900 px-4 py-2.5 rounded-2xl border border-slate-250 dark:border-zinc-800 shadow-sm flex items-center gap-2">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-300 leading-relaxed max-w-sm mx-auto font-medium">
            You can donate any small amount of your choice, such as <span className="text-emerald-600 dark:text-emerald-400 font-black bg-emerald-50 dark:bg-emerald-950/40 px-2.5 py-1 rounded-lg">₹10, ₹20, or ₹50</span>. Your small contribution helps keep our servers running and maintains the domain so we can continue serving you completely free tools!
          </p>
        </div>
