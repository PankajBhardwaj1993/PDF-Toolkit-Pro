...
export default function CanonicalTestWorkstation({ onBackToTools }: CanonicalTestWorkstationProps) {
  ...
  const [genPath, setGenPath] = useState<string>('/tools/merge-pdf');
  ...
  // Live canonical element checker
  ...
  return (
    <div className="space-y-6">
      <SEO 
        title="SEO & Canonical Tag Tester | PDF Toolkit Pro"
        description="Verify, validate, and debug search-engine canonical links across all PDF Toolkit Pro tool workspaces. Run bulk SEO checks instantly."
        canonical="/tools/canonical_tag_test"
      />
            ...
            <div className="space-y-3">
              ...
              <div className="pt-2 flex items-center gap-2">
                ...
                <span className="text-[10px] text-slate-500 dark:text-zinc-400 leading-normal">
                  Our SPA routers update the header tags reactively on path switches.
                </span>
              </div>
            </div>
          </div>
