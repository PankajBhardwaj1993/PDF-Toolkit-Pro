        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8 bg-slate-50/50 dark:bg-zinc-950/50">
          <div 
            ...
            className={`max-w-xl w-full border-2 border-dashed rounded-3xl p-12 text-center transition-all cursor-pointer select-none ${
              isDragOver ? 'border-rose-500 bg-rose-50/50 dark:bg-rose-900/10 scale-[1.02]' : 'border-slate-300 dark:border-zinc-800 hover:border-rose-400 dark:hover:border-rose-500 bg-white/60 dark:bg-zinc-900/30'
            }`}
          ...
          >
            <div className="h-20 w-20 bg-rose-100 dark:bg-rose-900/40 text-rose-600 dark:text-rose-400 rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm">
            ...
            <button 
              ...
              className="px-6 py-3 bg-rose-600 hover:bg-rose-700 text-white font-semibold rounded-xl cursor-pointer shadow-md transition-all inline-flex items-center gap-2"
            >
