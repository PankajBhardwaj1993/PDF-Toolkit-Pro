              ...
              {sigType === 'draw' ? (
                ...
                <div className="space-y-4">
                  ...
                  <div 
                    ...
                    className="border-2 border-dashed border-slate-200 dark:border-zinc-800 rounded-xl p-8 text-center hover:border-blue-500 transition-colors cursor-pointer select-none"
                  >
                    <div className="flex flex-col items-center">
                      <Upload className="h-8 w-8 text-blue-500 mb-2" />
                      <span className="text-sm font-semibold text-slate-700 dark:text-zinc-200">Click to upload signature image</span>
