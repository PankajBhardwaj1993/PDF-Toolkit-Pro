...
export default function PricingView({ user, onLoginRequest, onSubscriptionUpdated }: PricingViewProps) {
  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8">
      <SEO 
        title="Pricing Plans – Free & Pro Access | PDF Toolkit Pro" 
        description="Affordable pricing plans for PDF Toolkit Pro. Free basic tools and premium Pro features with unlimited conversions, AI tools, and priority support." 
        canonical="https://pdftoolkitpro.online/pricing" 
        keywords={['PDF tools pricing', 'free PDF tools', 'PDF converter pricing', 'pro PDF tools']}
      />
