      ...
      {!file ? (
        <div id="metadata-upload-container" className="bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-white/10 rounded-2xl p-8 sm:p-12 text-center shadow-xs">
          <div 
            ...
            className="border-2 border-dashed border-slate-300 dark:border-zinc-700 hover:border-rose-500 dark:hover:border-rose-500 rounded-2xl p-8 sm:p-12 transition-all flex flex-col items-center justify-center gap-4 bg-slate-50/50 dark:bg-zinc-900/30"
          >
